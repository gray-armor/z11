...
static void z_gl_texture_2d_destroy(struct z_gl_texture_2d* texture);

static void z_gl_texture_2d_handle_destroy(struct wl_resource* resource)
{
...
{
  UNUSED(client);
  struct z_gl_texture_2d* texture;
...
static const struct z11_gl_texture_2d_interface z_gl_texture_2d_interface = {
    .destroy = z_gl_texture_2d_protocol_destroy,
    .set_image = z_gl_texture_2d_protocol_set_image,
};
...
struct z_gl_texture_2d* z_gl_texture_2d_create(struct wl_client* client, uint32_t id)
{
  ...
  wl_resource_set_implementation(resource, &z_gl_texture_2d_interface, texture,
                                 z_gl_texture_2d_handle_destroy);
