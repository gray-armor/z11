...
static void zazen_opengl_vertex_buffer_destroy(
    struct zazen_opengl_vertex_buffer *vertex_buffer);

static void zazen_opengl_vertex_buffer_handle_destroy(
...
static void zazen_opengl_vertex_buffer_protocol_destroy(
...
static void zazen_opengl_vertex_buffer_raw_buffer_destroy_listener(
    struct wl_listener *listener, void *data)
{
  UNUSED(data);
  struct zazen_opengl_vertex_buffer *vertex_buffer;

  vertex_buffer = wl_container_of(listener, vertex_buffer,
                                  raw_buffer_resource_destroy_listener);
...
static void zazen_opengl_vertex_buffer_protocol_attach(
    struct wl_client *client, struct wl_resource *resource,
    _Nullable struct wl_resource *raw_buffer, uint32_t vertex_stride)
{
  UNUSED(client);
  struct zazen_opengl_vertex_buffer *vertex_buffer =
      wl_resource_get_user_data(resource);
  ...
  wl_resource_add_destroy_listener(
      raw_buffer, &vertex_buffer->raw_buffer_resource_destroy_listener);

  wl_signal_emit(&vertex_buffer->state_change_signal, vertex_buffer);
}

static const struct z11_opengl_vertex_buffer_interface
    zazen_opengl_vertex_buffer_interface = {
    ...
    struct wl_client *client, uint32_t id)
{
  ...
  resource =
      wl_resource_create(client, &z11_opengl_vertex_buffer_interface, 1, id);
  ...
  wl_resource_set_implementation(
      resource, &zazen_opengl_vertex_buffer_interface, vertex_buffer,
