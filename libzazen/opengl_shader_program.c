...
static void zazen_opengl_shader_program_destroy(struct zazen_opengl_shader_program* shader_program);

static void zazen_opengl_shader_program_handle_destroy(struct wl_resource* resource)
{
  struct zazen_opengl_shader_program* shader_program = wl_resource_get_user_data(resource);

  zazen_opengl_shader_program_destroy(shader_program);
}

static void zazen_opengl_shader_program_protocol_destroy(struct wl_client* client,
...
static const struct z11_opengl_shader_program_interface zazen_opengl_shader_program_interface = {
                                                                       ...
                                                                       const char* fragment_shader_source)
{
  ...
  resource = wl_resource_create(client, &z11_opengl_shader_program_interface, 1, id);
  if (resource == NULL) {
    wl_client_post_no_memory(client);
  ...
  if (shader_program->vertex_shader_source == NULL) goto no_mem_vertex_shader_source;
  shader_program->fragment_shader_source = strdup(fragment_shader_source);
  if (shader_program->fragment_shader_source == NULL) goto no_mem_fragment_shader_source;

  wl_resource_set_implementation(resource, &zazen_opengl_shader_program_interface, shader_program,
