                              ...
                              const char* vertex_shader_source, const char* fragment_shader_source)
{
  ...
  glShaderSource(vertex_shader_id, 1, (const char**)&vertex_shader_source, NULL);
  ...
  glShaderSource(fragment_shader_id, 1, (const char**)&fragment_shader_source, NULL);
  glCompileShader(fragment_shader_id);
  GLint fragment_shader_compiled = GL_FALSE;
  glGetShaderiv(fragment_shader_id, GL_COMPILE_STATUS, &fragment_shader_compiled);
  ...
  glGetProgramiv(back_state->shader_program_id, GL_LINK_STATUS, &program_success);
...
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast"
    glVertexAttribPointer(vertex_input_attribute->location, size, type, GL_FALSE, back_state->vertex_stride,
