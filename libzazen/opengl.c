...
static void zazen_opengl_protocol_create_vertex_buffer(struct wl_client *client, struct wl_resource *resource,
                                                       uint32_t id)
{
  UNUSED(resource);
...
static void zazen_opengl_protocol_create_shader_program(struct wl_client *client,
...
static void zazen_opengl_protocol_create_texture_2d(struct wl_client *client, struct wl_resource *resource,
                                                    uint32_t id)
{
  UNUSED(resource);
...
static void zazen_opengl_bind(struct wl_client *client, void *data, uint32_t version, uint32_t id)
{
  ...
  wl_resource_set_implementation(resource, &zazen_opengl_interface, opengl, NULL);
}
...
struct zazen_opengl *zazen_opengl_create(struct wl_display *display)
{
  ...
  if (wl_global_create(display, &z11_opengl_interface, 1, opengl, zazen_opengl_bind) == NULL) goto out;
