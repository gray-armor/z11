...
static const struct z11_cuboid_window_listener cuboid_window_listener = {
    [](void *data, struct z11_cuboid_window *z11_cuboid_window,
      ...
      DragAndDrop *app = (DragAndDrop *)data;
...
DragAndDrop::DragAndDrop(const char *filename, const char *mime_type)
{
...
bool DragAndDrop::Init()
{
  ...
  zwindow_ = new ZWindow<DragAndDrop>(this);
...
void DragAndDrop::ResizeEvent(wl_fixed_t width, wl_fixed_t height,
                              wl_fixed_t depth)
{
...
void DragAndDrop::HandleRayEnter(struct z11_ray *ray, uint32_t serial,
...
void DragAndDrop::HandleRayMotion(struct z11_ray *ray, uint32_t time,
                                  float ray_origin_x, float ray_origin_y,
                                  float ray_origin_z, float ray_direction_x,
                                  float ray_direction_y, float ray_direction_z)
{}

void DragAndDrop::HandleRayLeave(struct z11_ray *ray, uint32_t serial,
                                 struct z11_cuboid_window *cuboid_window)
{}
#pragma GCC diagnostic pop

void DragAndDrop::HandleRayButton(struct z11_ray *ray, uint32_t serial,
...
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wunused-parameter"
void DragAndDrop::HandleKeyboardKeymap(struct z11_keyboard *keyboard,
                                       uint32_t format, int fd, uint32_t size)
{}

void DragAndDrop::HandleKeyboardEnter(struct z11_keyboard *keyboard,
                                      uint32_t serial,
                                      struct z11_cuboid_window *cuboid_window,
                                      struct wl_array *keys)
{}

void DragAndDrop::HandleKeyboardLeave(struct z11_keyboard *keyboard,
                                      uint32_t serial,
                                      struct z11_cuboid_window *cuboid_window)
{}

void DragAndDrop::HandleKeyboardKey(struct z11_keyboard *keyboard,
                                    uint32_t serial, uint32_t time,
                                    uint32_t key, uint32_t state)
{}

void DragAndDrop::HandleKeyboardModifiers(struct z11_keyboard *keyboard,
                                          uint32_t serial,
...
int main(int argc, char const *argv[])
{
  ...
  const char *mime_type = argv[2];
  DragAndDrop *app = new DragAndDrop(filename, mime_type);
